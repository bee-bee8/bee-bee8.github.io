(function () {
  ...
  const STYLE_ID = "tool-home-nav-en-style";
  ...
  function findMountRoot() {
    return (
      document.querySelector("[data-tool-home-nav-en-root]") ||
  ...
  function initToolHomeNav() {
    ...
    link.href = HOME_URL;
    link.target = "_top";
    link.setAttribute("aria-label", "Back to Tools Page");
  ...
  function ensureFullscreenControls(mountRoot) {
    ...
    if (!controls) {
      ...
      controls.setAttribute("aria-label", "Fullscreen Control");
    ...
    const exitButton = ensureButton(
      ...
      EXIT_FULLSCREEN_ID,
      "Exit",
      "Press ESC or this button to exit fullscreen"
    );
